...
// configuration step. It creates a namespace called `mando`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", mando::cmake::project_name, mando::cmake::project_version) };
